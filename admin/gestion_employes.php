...
<a href="ajout_employe.php" class="btn btn-primary" role="button">Ajout Employe</a>
  ...
  <table class="table table-bordered">
    ...
    <?php
      ...
      <tr>
        ...
        <td>
        <a href="delete_employe.php?id_employe=<?php echo $row['id'];?>" class="btn btn-danger" role="button">Delete</a>
        </td>
      </tr>
