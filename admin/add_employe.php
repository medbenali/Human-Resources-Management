...
$sql="INSERT INTO `employe`(`nom`, `prenom`, `email`, `sexe`, `adresse`, `pays`, `ville`, `codePostal`, `telephoneFixe`, `gsm`, `dateNaissance`, `lieuNaissance`, `etatCivile`, `compteUtilisateur`, `login`, `pwd`) 
